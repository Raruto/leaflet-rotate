    ...
    debug: function(map, options = {}) {
        ...
        <table class="leaflet-rotate-info">
          <tr>
            ...
            <td>
              <input type="range" min="0" max="360" step="1" value="0" name="rho" id='rho_input' /><span id='rho'></span>
            </td>
            <td>
              <strong>Padding: </strong>
              <input type="range" min="-0.25" max="0" value="0" step="0.01" name="pad" id='pad_input' />
            </td>
            <td>
